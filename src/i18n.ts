...
const en: T = {
  ...
  industriesNote: 'Active client work shown under NDA codenames. Hover for case study.',
...
const ka: T = {
  ...
  industriesNote: 'მიმდინარე პროექტები NDA კოდური სახელებით. გადაიყვანე გვერდი დეტალებისთვის.',
...
const ru: T = {
  ...
  industriesNote: 'Активные проекты под NDA-кодовыми именами. Наведите для деталей.',
  nowBuilding: 'СЕЙЧАС СТРОИМ',
  nowBuildingItem1: '3 активных проекта',
  nowBuildingItem2: 'Q3 2026 когорта',
  indFintech: 'Финтех',
  indCommerce: 'E-commerce',
  ...
  proj1Category: 'Финтех · платёжная инфраструктура',
  proj1Desc: 'Трансграничная платёжная система с $400M+ годового оборота, реал-тайм скорингом фрода и поддержкой 7 валют.',
  proj1Challenge: 'Замена устаревшего, нестабильного гейтвея и обработка крупных трансграничных платежей в строгих регуляторных условиях без даунтайма.',
  proj1Solution: 'Event-driven микросервисы на AWS с мульти-региональным failover, ML-скорингом фрода и собственным ledger с криптографическим аудит-трейлом. $90M в движении мигрировано без единой проваленной транзакции.',
  proj2Category: 'E-commerce · multi-vendor SaaS',
  proj2Desc: 'Корпоративная маркетплейс-платформа: 500+ продавцов, 15К заказов в месяц, синхронизация инвентаря в реальном времени между 6 центрами фулфилмента.',
  proj2Challenge: 'Объединение трёх устаревших commerce-стеков в одну multi-tenant платформу с реал-тайм инвентарём в распределённом фулфилменте.',
  proj2Solution: 'Next.js headless-витрина, WebSocket inventory bus, автоматическая 3PL-маршрутизация и AI-маппинг SKU. Время онбординга каталога с 6 недель до 3 дней.',
  proj3Category: 'Здравоохранение · платформа для пациентов',
  proj3Desc: 'HIPAA-grade телемедицина и управление пациентами: 200+ консультаций в день, 18 клиник.',
  proj3Challenge: 'Цифровизация 18 клиник на одной HIPAA-grade платформе с телемедициной, автоматическим расписанием и audit-ready записями.',
  proj3Solution: 'End-to-end шифрованное видео на WebRTC, EHR с ролевым доступом, SMS/email-каденция напоминаний и FHIR-совместимое хранилище. Развёрнуто в 18 клиниках за 11 недель.',
  proj4Category: 'Логистика · флот-операции',
  proj4Desc: 'Управление флотом в реальном времени и оптимизация маршрутов для 200+ машин в 3 странах, прогнозный ETA и 30% экономии топлива.',
  proj4Challenge: 'Замена бумажной и табличной диспетчерской на реал-тайм платформу флот-операций для 200+ машин в 3 странах.',
  proj4Solution: 'Собственный routing-движок с дорожными и погодными входами, GPS 1Hz, прогнозный ETA на исторической телеметрии и PWA для водителей.',
  proj5Category: 'EdTech · живое обучение',
  proj5Desc: 'Интерактивная платформа обучения с живыми когортами, AI-тьюторингом и геймификацией. 10К+ активных учеников.',
  proj5Challenge: 'Превращение медленной legacy LMS в live-first платформу с персонализированными путями и измеримыми результатами.',
  proj5Solution: 'Реал-тайм класс на WebRTC, XP-система прогресса и рекомендатор контента на Gemini с фильтрами безопасности.',
  proj6Category: 'DeFi · аналитика портфеля',
  proj6Desc: 'Multi-chain DeFi-аналитика: $50M+ AUM в 20+ протоколах с автоматическим исполнением yield-стратегий.',
  proj6Challenge: 'Агрегация надёжных реал-тайм данных портфеля по фрагментированным DeFi-протоколам и безопасное исполнение yield-стратегий.',
  proj6Solution: 'Multi-chain индексер с WebSocket ценами, risk-scored strategy router и sandbox-симуляция для one-click исполнения. Аудит от Trail of Bits.',
