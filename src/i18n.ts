...
const ru: T = {
  ...
  metaTitle: 'Blueberry Systems · Агентство разработки ПО в Тбилиси',
  metaDescription: 'Blueberry Systems — сениорное агентство разработки ПО в Тбилиси. Создаём веб-платформы, мобильные приложения, SaaS-продукты и AI/ML системы для финтеха, здравоохранения, e-commerce и EdTech.',
