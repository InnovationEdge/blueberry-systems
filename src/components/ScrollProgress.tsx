...
export function NowBuilding({ projects }: { projects: string[] }) {
  ...
  return (
    <motion.div
      ...
      className="hidden md:flex fixed bottom-6 left-6 z-40 items-center gap-3 px-3.5 py-2 rounded-full bg-white/90 dark:bg-zinc-950/85 backdrop-blur-xl border border-black/[0.08] dark:border-white/[0.08] shadow-xl shadow-black/10 dark:shadow-black/30"
    >
